...
urlpatterns = [
    ...
    path(
        "doctor/workspace/patient/<int:patient_id>/plan-item/<int:plan_item_id>/followup-detail/<str:code>/",
        views.patient_followup_detail_toggle,
        name="patient_followup_detail_toggle",
    ),
    path(
